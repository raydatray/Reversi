...
RUNTIME = open("abruntime.txt", "a")
SCORES = open("abgames.txt", "a")
...
def _choose_move(board, player):
    ...
    def a_b(board, depth, a, b, player):
        ...
        if player == COMPUTER:
            ...
            for move in moves:
                ...
                val =  a_b(dupe_board, depth - 1, a, b, _get_opponent(player))
    ...
    for move in moves:
        val = a_b(board, 3, -inf, inf, player)
